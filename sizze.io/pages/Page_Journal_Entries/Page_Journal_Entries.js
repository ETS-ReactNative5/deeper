...
const Page_Journal_Entries  = ({navigation}) => {
	useEffect(() => {
	}, []);
	const onClick_layer_a56f7e = () => {
					navigation.navigate("Page_Journal")
	}
	return (
	<KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{height: Dimensions.get("window").height}}>
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<Animated.View style={[{}, noneModeStyles._page11]}    >
			<View style = {noneModeStyles._Home_Indicator}    >
				<View style = {noneModeStyles._Home_Indicator_2}    >
				</View>
			</View>
			<View style = {noneModeStyles._Icon_Back}    >
				<View style = {noneModeStyles._layer_a56f7e}  onStartShouldSetResponder = {() => {return true}} onResponderGrant = {() => {}} onResponderRelease = {() => {onClick_layer_a56f7e();}} onStartShouldSetResponderCapture = {() => true}>
					<View style = {noneModeStyles._layer_b144d2}   >
			...
			<View style = {noneModeStyles._Card_List}    >
				<Text style = {noneModeStyles._Past_Entries}   >
					Past Entries
				</Text>
...
export default Page_Journal_Entries
